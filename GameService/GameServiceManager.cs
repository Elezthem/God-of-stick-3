...
namespace EasyMobile
{
    ...
    public class GameServiceManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Reports score to the given leaderboard.
        /// </summary>
        ...
        #if UNITY_ANDROID && EM_GPGS
        static GooglePlayGames.BasicApi.LeaderboardTimeSpan AsGPGSLeaderboardTimeSpan(TimeScope timeScope)
        {
            switch (timeScope)
            {
                ...
                case TimeScope.Today:
                    return GooglePlayGames.BasicApi.LeaderboardTimeSpan.Daily;
                default:
                    return GooglePlayGames.BasicApi.LeaderboardTimeSpan.AllTime;
            }
        }
